...
export default function AppLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        name="royalties"
        options={{ title: 'Royalties', tabBarLabel: 'Royalties', tabBarButtonTestID: 'tab-royalties', tabBarIcon: makeIcon('royalties') }}
      />
      <Tabs.Screen
        name="profile"
        options={{ title: 'Profilo', tabBarLabel: 'Profilo', tabBarButtonTestID: 'tab-profilo', tabBarIcon: makeIcon('profile') }}
      />
      <Tabs.Screen
        name="beacon-config"
